...
const resources = {
  en: {
    translation: {
      ...
      fact1: "🎓 B.E. in Computer Engineering",
      ...
      experience2Tag: "VIO Agency",
      experience1Tag: "FPT Polytechnic",
      ...
      descriptionVio: "VioAcademy is an integrated online education platform that helps learners access courses ranging from basic to advanced levels in the field of information technology.The project combines React for the frontend and Spring Boot for the backend, ensuring fast response times and secure data handling.The system includes a fully implemented course management module, user registration, and test assignment features using Java and MySQL.",
      noteVio: "This project has been completed 100% and is currently live.",
      descriptionMyShop: "My Shop is an e-commerce website built with React and Spring Boot, allowing users to browse products, add them to a cart, and make online payments. This project uses Java and MySQL to manage product and order data, ensuring security and high performance. Currently, the project is under development and will be launched soon. (completed 30%)",
  ...
  vi: {
    translation: {
      ...
      fact1: "🎓 Cử nhân Kỹ thuật Máy tính",
      ...
      descriptionVio: "VioAcademy là nền tảng giáo dục trực tuyến tích hợp, hỗ trợ học viên tiếp cận các khóa học từ cơ bản đến nâng cao trong lĩnh vực công nghệ thông tin. Dự án kết hợp giữa React cho frontend và Spring Boot cho backend, đảm bảo tốc độ phản hồi nhanh và bảo mật dữ liệu. Hệ thống quản lý khóa học, đăng ký tài khoản và giao bài kiểm tra đều được xử lý hoàn chỉnh với Java và MySQL.",
      noteVio: "Dự án này đã hoàn thành 100% và đang hoạt động.",
      descriptionMyShop: "My Shop là một trang web thương mại điện tử được xây dựng bằng React và Spring Boot, cho phép người dùng duyệt sản phẩm, thêm vào giỏ hàng và thanh toán trực tuyến. Dự án này sử dụng Java và MySQL để quản lý dữ liệu sản phẩm và đơn hàng, đảm bảo tính bảo mật và hiệu suất cao. Hiện tại, dự án đang trong quá trình phát triển và sẽ sớm ra mắt. (hoàn thành 30%)",
